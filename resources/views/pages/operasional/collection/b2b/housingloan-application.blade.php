...
<div class="statbox widget box box-shadow">
    <div class="form-row " id="form-getdata-housing-loan" style="padding:10px !important;">
        <div class="form-group col-md-12 form-channel">
            <a href="#" class="btn btn-primary btn-sm" onclick="tambahDataHousingLoan();">Tambah Data</a>
        </div>
        <div class="form-group col-md-12 form-tahun">
            <label for="bulan_tahun">Year</label>
            <input type="text" class="form-control flatpickr flatpickr-input active" name="bulan_tahun" placeholder="Bulan dan tahun" id="bulan_tahun">
        </div>
        <div class="form-group col-md-12 form-channel">
