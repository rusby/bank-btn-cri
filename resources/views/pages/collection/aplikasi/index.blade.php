...
<div class="page-header">
    <div class="page-title">
        <h3>Pengajuan & Daftar Aplikasi</h3>
    </div>
</div>
<div class="row layout-top-spacing" id="cancel-row">
    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
        <div class="widget-content widget-content-area br-6">
            <form action="{{ route('collection.export.collection_tabulasi') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="filter_jenis_kpr" class="form-control" style="width: 200px">
                            ...
                            <option value="KPR Komersial (Baru atau Secondary)">KPR Komersial (Baru atau Secondary)
                            </option>
...
<script>
    $(document).ready(function() {
        var table = $('#table-Datatable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('collection.aplikasi.dataTables') }}",
                data: function(d) {
            ...
            {
                data: function(row) {
                    if (row.jenis_sub_kredit) {
                        return `${row.jenis_kredit} - ${row.jenis_sub_kredit}`
                    }
                    return `${row.jenis_kredit}`
